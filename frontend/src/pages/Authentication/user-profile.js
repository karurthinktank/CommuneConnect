...
function UserProfile(){
  ...
  //meta title
  document.title = "Profile | ElawFirm";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumb title="Elawfirm" breadcrumbItem="Profile" />
          ...
          <Row>
            <Col lg="12">
              ...
              <Link to="/edit-profile" className="">
                <button type="button" className="btn btn-primary "><span className="mdi mdi-pencil me-2"></span>Edit profile</button>
                </Link>
                    </div>
                  </div>
                </CardBody>
